...
function validAggregate(): ProductAggregateInput {
  return {
    ...
    colorways: [{ id: 'AX1-010', productId: 'AX-1', styleColor: 'AX1-010', name: 'Black', colorFamily: 'Black', swatchHex: '#111111', price: 1000, isDefault: true, onSale: false, images: ['https://example.com/image.jpg'] }],
