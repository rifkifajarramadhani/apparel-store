...
const aggregate: ProductAggregateInput = {
  ...
  colorways: [
    { id: 'AX1-010', productId: 'AX-1', styleColor: 'AX1-010', name: 'Black', colorFamily: 'Black', swatchHex: '#111111', price: 1000, isDefault: true, onSale: false, images: ['https://example.com/black.jpg'] },
    { id: 'AX1-100', productId: 'AX-1', styleColor: 'AX1-100', name: 'White', colorFamily: 'White', swatchHex: '#ffffff', price: 800, isDefault: false, onSale: true, images: ['https://example.com/white.jpg'] },
  ],
  skus: [
